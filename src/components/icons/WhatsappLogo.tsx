...
export default function WhatsappLogo({...props}) {
    ...
    return (
        <svg onMouseOver={() => setFocusedLogo(true)} onMouseLeave={() => setFocusedLogo(false)} fill={focusedLogo ? '#25d366' : '#FFF'} width="30px" height="30px" viewBox="0 0 22 22" version="1.1" xmlns="http://www.w3.org/2000/svg">
